...
const Products = () => {
  ...
  if (error) {
    return <ErrorWidget message={error} onRetry={fetchProducts} />
  }
        ...
        {products.map((product) => (
          <div
            ...
            <div
              ...
              <img
                src={product.image || "https://fakestoreapi.com/img"}
                alt={product.title}
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex justify-center">
                  <img
                    src={selectedProduct.image || "https://fakestoreapi.com/img"}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 pt-4">
                    <button className="flex-1 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 font-semibold">🛒 Savatga qo'shish
                    </button>
